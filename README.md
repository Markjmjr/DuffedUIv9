...
Date | Change
--- | ---
2020-09-05 | Fixed issue with removed font<br />Moved debufflistings to more separate files<br />Fixed hoverbind, DuffedUI uses now the Quickbind-Function from Blizzard and commands works as known
